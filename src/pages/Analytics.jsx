  ...
  return (
    <div className="space-y-md lg:space-y-lg relative pb-xl">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-sm lg:gap-gutter">
        <div className="bg-surface-container border border-white/[0.06] p-md flex flex-col justify-between hover:border-primary-container/30 transition-colors group">
          <span className="font-label-bold text-on-surface/40 uppercase text-[10px] tracking-wider mb-sm">Total Revenue</span>
        ...
        <div className="bg-surface-container border border-white/[0.06] p-md flex flex-col justify-between hover:border-primary-container/30 transition-colors group">
          <span className="font-label-bold text-on-surface/40 uppercase text-[10px] tracking-wider mb-sm">Avg Attendance (Month)</span>
          <div className="flex items-end justify-between">
        ...
        <div className="bg-surface-container border border-white/[0.06] p-md flex flex-col justify-between hover:border-primary-container/30 transition-colors group">
          <span className="font-label-bold text-on-surface/40 uppercase text-[10px] tracking-wider mb-sm">Active Members %</span>
          <div className="flex items-end justify-between">
