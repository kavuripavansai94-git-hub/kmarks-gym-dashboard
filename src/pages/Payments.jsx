      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-sm lg:gap-gutter">
        ...
        <div className="group relative bg-surface-container border border-white/[0.06] p-sm lg:p-md overflow-hidden hover:border-primary-container/30 transition-all">
          <div className="absolute right-4 top-0 bottom-0 flex items-center justify-center text-white/[0.02] font-bold select-none group-hover:scale-110 group-hover:text-white/[0.05] group-hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.15)] transition-all duration-500 pointer-events-none">
            <span className="material-symbols-outlined text-[64px] leading-none block">account_balance</span>
          </div>
        ...
        >
          ...
          <div className="absolute right-4 top-0 bottom-0 flex items-center justify-center text-white/[0.02] font-bold select-none group-hover:scale-110 group-hover:text-green-500/10 group-hover:drop-shadow-[0_0_15px_rgba(34,197,94,0.4)] transition-all duration-500 pointer-events-none">
            <span className="material-symbols-outlined text-[64px] leading-none block">check_circle</span>
          </div>
          <div className="flex items-center justify-between relative z-10">
            <div>
        ...
        >
          ...
          <div className="absolute right-4 top-0 bottom-0 flex items-center justify-center text-white/[0.02] font-bold select-none group-hover:scale-110 group-hover:text-yellow-500/10 group-hover:drop-shadow-[0_0_15px_rgba(234,179,8,0.4)] transition-all duration-500 pointer-events-none">
            <span className="material-symbols-outlined text-[64px] leading-none block">pending_actions</span>
          </div>
          <div className="flex items-center justify-between relative z-10">
            <div>
        ...
        >
          ...
          <div className="absolute right-4 top-0 bottom-0 flex items-center justify-center text-white/[0.02] font-bold select-none group-hover:scale-110 group-hover:text-error/10 group-hover:drop-shadow-[0_0_15px_rgba(239,68,68,0.4)] transition-all duration-500 pointer-events-none">
