    ...
    <div className="space-y-lg relative">
      <section className="relative overflow-hidden border border-white/5 bg-gradient-to-br from-surface-container via-surface-container-high to-surface-container">
        ...
        <div className="relative p-md lg:py-md lg:px-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-md">
          <div>
            <p className="font-label-bold text-[10px] text-primary-container uppercase tracking-[0.3em] mb-xs">Gym Operations</p>
      ...
      <div className="bg-surface-container border border-white/[0.06] p-xl flex flex-col items-center justify-center min-h-[400px] text-center">
        <span className="material-symbols-outlined text-on-surface/15 text-[64px] mb-md">calendar_month</span>
        <h2 className="font-headline-md text-white uppercase mb-sm">Attendance Coming Soon</h2>
        <p className="font-body-md text-on-surface/60 max-w-md">The attendance tracking module is currently being built. You will soon be able to track member check-ins and check-outs here.</p>
      </div>
    </div>
  );
}
