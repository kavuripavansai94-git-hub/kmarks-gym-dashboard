      ...
      <div className="grid grid-cols-3 gap-sm lg:gap-gutter">
        ...
        >
          ...
          <div className="absolute right-4 top-0 bottom-0 flex items-center justify-center text-white/[0.02] font-bold select-none group-hover:scale-110 group-hover:text-white/[0.05] transition-all duration-500 pointer-events-none">
            ...
            <span className="material-symbols-outlined text-[64px] leading-none block relative z-10">schedule</span>
          </div>
          <div className="flex items-center justify-between relative z-10">
            <div>
        ...
        >
          ...
          <div className="absolute right-4 top-0 bottom-0 flex items-center justify-center text-white/[0.02] font-bold select-none group-hover:scale-110 group-hover:text-white/[0.05] transition-all duration-500 pointer-events-none">
            ...
            <span className="material-symbols-outlined text-[64px] leading-none block relative z-10">cancel</span>
          </div>
          <div className="flex items-center justify-between relative z-10">
            <div>
